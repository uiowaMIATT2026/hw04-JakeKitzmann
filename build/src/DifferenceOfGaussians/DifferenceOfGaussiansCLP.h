...
//  /Users/jacob_kitz/dev/SEM-build/GenerateCLP/bin/GenerateCLP --InputXML /Users/jacob_kitz/Coursework/ECE5490/hw04-JakeKitzmann/src/DifferenceOfGaussians/DifferenceOfGaussians.xml --OutputCxx /Users/jacob_kitz/Coursework/ECE5490/hw04-JakeKitzmann/build/src/DifferenceOfGaussians/DifferenceOfGaussiansCLP.h
//
#include <cstdio>
#include <cstdlib>
#include <iostream>
...
"    <title>DifferenceOfGaussians</title>\n"
"    <description>\n"
"        Difference of Gaussians image edge detection.\n"
"    </description>\n"
...
"        <description>Smoothing parameters</description>\n"
"        <float>\n"
"            <longflag>sigma1</longflag>\n"
"            <label>First sigma for gaussian smoothing function. sigma1 should be less than sigma2 </label>\n"
"        </float>\n"
"        <float>\n"
"            <longflag>sigma2</longflag>\n"
"            <label>Second sigma for gaussian smoothing function. sigma2 should be greater than sigma1 </label>\n"
"        </float>\n"
"    </parameters>\n"
"</executable>\n"
"\n"
...
#define GENERATE_TCLAP_PARSE \
 ...
 \
    msg.str("");msg << "";    TCLAP::ValueArg<float > sigma1Arg("", "sigma1", msg.str(), false, sigma1, "float", commandLine); \
 \
    msg.str("");msg << "";    TCLAP::ValueArg<float > sigma2Arg("", "sigma2", msg.str(), false, sigma2, "float", commandLine); \
 \
