...
//  /Users/jacob_kitz/dev/SEM-build/GenerateCLP/bin/GenerateCLP --InputXML /Users/jacob_kitz/Coursework/ECE5490/hw04-JakeKitzmann/src/GradientAD/GradientAD.xml --OutputCxx /Users/jacob_kitz/Coursework/ECE5490/hw04-JakeKitzmann/build/src/GradientAD/GradientADCLP.h
//
#include <cstdio>
#include <cstdlib>
#include <iostream>
...
"    <title>GradientAD</title>\n"
"    <description>\n"
"        Gradient based anisotropic diffusion smoothing\n"
"    </description>\n"
...
"\n"
"    <parameters>\n"
"        <label>anisoParam</label>\n"
"        <description>Gradient based anisotropic diffusion parameters</description>\n"
"        <double>\n"
...
#define GENERATE_TCLAP_PARSE \
 ...
 \
    msg.str("");msg << "";    TCLAP::ValueArg<double > conductanceArg("", "conductance", msg.str(), false, conductance, "double", commandLine); \
 \
    msg.str("");msg << "";    TCLAP::ValueArg<double > timeStepArg("", "timeStep", msg.str(), false, timeStep, "double", commandLine); \
 \
    msg.str("");msg << "";    TCLAP::ValueArg<int > iterationsArg("", "iterations", msg.str(), false, iterations, "int", commandLine); \
 \
